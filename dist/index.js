...
async function handleToolCall(name, args) {
    switch (name) {
        ...
        case "drawing_generateCanvas":
            try {
                ...
                return {
                    content: [{
                            type: "text",
                            text: `Failed to generate canvas: ${error.message}`,
                        }],
                    isError: true,
                };
            }
        case "drawing_fillRectangle":
            ...
            try {
                drawingTool.fillRectangle(currentCanvas, args.x, args.y, args.width, args.height, args.color);
                return {
                    content: [{
                            type: "text",
                ...
                return {
                    content: [{
                            type: "text",
                            text: `Failed to fill rectangle: ${error.message}`,
                        }],
                    isError: true,
                };
            }
        case "drawing_getCanvasPng": // Updated tool name
            ...
            try {
                ...
                return {
                    content: [{
                            type: "text",
                            text: `Failed to get canvas PNG data: ${error.message}`,
                        }],
                    isError: true,
                };
            }
        case "drawing_getCanvasData":
            ...
            try {
                ...
                return {
                    content: [{
                            type: "text",
                            text: `Failed to get canvas data: ${error.message}`,
                        }],
                    isError: true,
                };
            }
